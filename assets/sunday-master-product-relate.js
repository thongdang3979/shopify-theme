let CUSTOM_MASTER_PRODUCT_RELATE = {
    init: function () {
        // Master Product Slider Reate Control 
        this.master_product_relate_control();
    },
    ...
    master_product_relate_control: function () {
        ...
        jQuery(document).ready(function ($) {
            let $group_product_slider = $('.group-product-slider');

            if ($group_product_slider.length > 0) {
...
CUSTOM_MASTER_PRODUCT_RELATE.init();
