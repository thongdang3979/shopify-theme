let CUSTOM_MASTER_FEATURED_PRODUCT = {
    init: function () {
        // Master Featured Product Slider Control 
        this.master_featured_product_slider_control();
    },
    ...
    master_featured_product_slider_control: function () {
        ...
        jQuery(document).ready(function ($) {
            let $featured_product_slider = $('.featured-product-slider');

            if ($featured_product_slider.length > 0) {
...
CUSTOM_MASTER_FEATURED_PRODUCT.init();
